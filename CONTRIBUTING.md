Contributing to Blessing Core
============================

The Blessing Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/blessing-project/blessing/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Blessing Core project, and is not to be
confused with overall Blessing Network Protocol consensus changes.

Whether a pull request is merged into Blessing Core rests with the project merge
...
Patches that change Blessing consensus rules are considerably more involved than
...
Where a patchset proposes to change the Blessing consensus, it must have been
...
The project leader is the release manager for each Blessing Core release.
