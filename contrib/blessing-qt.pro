...
RESOURCES += src/qt/blessing.qrc src/qt/blessing_locale.qrc

TRANSLATIONS += src/qt/locale/blessing_bg.ts \
                src/qt/locale/blessing_de.ts \
                src/qt/locale/blessing_en.ts \
                src/qt/locale/blessing_es.ts \
                src/qt/locale/blessing_fi.ts \
                src/qt/locale/blessing_fr.ts \
                src/qt/locale/blessing_it.ts \
                src/qt/locale/blessing_ja.ts \
                src/qt/locale/blessing_pl.ts \
                src/qt/locale/blessing_pt.ts \
                src/qt/locale/blessing_ru.ts \
                src/qt/locale/blessing_sk.ts \
                src/qt/locale/blessing_sv.ts \
                src/qt/locale/blessing_vi.ts \
                src/qt/locale/blessing_zh_CN.ts \
                src/qt/locale/blessing_zh_TW.ts
