/* src/config/blessing-config.h.  Generated from blessing-config.h.in by configure.  */
/* src/config/blessing-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BLES_CONFIG_H

#define BLES_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.blessing.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Blessing Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Blessing Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blessing"
