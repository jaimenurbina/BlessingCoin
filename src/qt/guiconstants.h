...
/* Blessing GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Blessing"
#define QAPP_ORG_DOMAIN "blessing.org"
#define QAPP_APP_NAME_DEFAULT "Blessing-Qt"
#define QAPP_APP_NAME_TESTNET "Blessing-Qt-testnet"
