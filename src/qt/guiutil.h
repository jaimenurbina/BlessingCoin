...
/** Utility functions used by the Blessing Qt UI.
 */
namespace GUIUtil
{
...
// Render Blessing addresses in monospace font
...
// Parse "blessing:" URI into recipient object, return true on successful parsing
