...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Blessing Core"),
     ...
     * override -datadir in the blessing.conf file in the default data directory
     * (to be consistent with blessingd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
