...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BLES);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBlessingAmount"))
        SoftSetArg("-anonymizeblessingamount", settings.value("nAnonymizeBlessingAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in blessing.cpp during shotdown to also remove the window positions
