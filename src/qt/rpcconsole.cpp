                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBLESPathCustom = GetArg("-zblesbackuppath", "");
    ...
    if(!strzBLESPathCustom.empty()) {
        ui->wallet_customzblesbackuppath->setText(QString::fromStdString(strzBLESPathCustom));
        ui->wallet_customzblesbackuppath_label->setVisible(true);
        ui->wallet_customzblesbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBLESPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Blessing RPC console.") + "<br>" +
