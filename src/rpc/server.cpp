...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Blessing server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Blessing server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Blessing features */
        {"blessing", "listmasternodes", &listmasternodes, true, true, false},
        {"blessing", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blessing", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blessing", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"blessing", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"blessing", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"blessing", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blessing", "masternodedebug", &masternodedebug, true, true, false},
        {"blessing", "startmasternode", &startmasternode, true, true, false},
        {"blessing", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blessing", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blessing", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blessing", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blessing", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blessing", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blessing", "preparebudget", &preparebudget, true, true, false},
        {"blessing", "submitbudget", &submitbudget, true, true, false},
        {"blessing", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blessing", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blessing", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blessing", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blessing", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blessing", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blessing", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blessing", "checkbudgets", &checkbudgets, true, true, false},
        {"blessing", "mnsync", &mnsync, true, true, false},
        {"blessing", "spork", &spork, true, true, false},
        {"blessing", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzblesseed", &getzblesseed, false, false, true},
        {"zerocoin", "setzblesseed", &setzblesseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbles", &searchdzbles, false, false, true},
        {"zerocoin", "dzblesstate", &dzblesstate, false, false, true},
...
{
    return "> blessing-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15577/\n";
}
