...
/**
 * Blessing RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZblesSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzblesseed(const UniValue& params, bool fHelp);
extern UniValue getzblesseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbles(const UniValue& params, bool fHelp);
extern UniValue dzblesstate(const UniValue& params, bool fHelp);
