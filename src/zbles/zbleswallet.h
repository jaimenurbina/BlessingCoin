...
#ifndef Blessing_ZBLESWALLET_H
#define Blessing_ZBLESWALLET_H
...
public:
    CzBLESWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBLES(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBLES(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
