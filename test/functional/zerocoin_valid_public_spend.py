...
from fake_stake.base_test import Blessing_FakeStakeTest

class zBLESValidCoinSpendTest(Blessing_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBLESs..." % DENOM_TO_USE)
